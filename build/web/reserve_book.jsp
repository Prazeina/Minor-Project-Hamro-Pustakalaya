...
<!--            <form action="reserve_book.jsp">
                ...
                <div class="form-group">
                    <label>Edition</label>
                    <input type="text" class="form-control" placeholder="Enter edition" name="editionname">
                </div>
                <div class="form-group">
                    
                    <input type="submit" class="btn btn-primary" value="submit request" name="bookname">
                </div>
